...
from estates.models import Address

# Create your models here.
# LOGIN DÓT - profile auka info. munum þurfa fasteign og þess háttar hér
class Profile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    #owned_property = models.OneToOneField(Address, on_delete=models.CASCADE)
...
class UserProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    # region_code = models.OneToOneField(Address, on_delete=models.CASCADE)
